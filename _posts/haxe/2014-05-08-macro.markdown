...
* `$a{} : Expr -> Array<Expr>` 用于把数量未确定的参数传递给函数, 示例见 Promhx 库的 Promise.when
...
* [最新支持 $tp](https://github.com/HaxeFoundation/haxe/commit/5411d122d03ed7c604c4afc559e9f0c8dbd1c8a4)
