...
# 优化配置? 文档 https://github.com/HaxeFoundation/haxe/blob/12a52b2fcdcecb4fafcc15288da3c8d2c0746aa5/analyzer.ml 第10行到20行为参数
...
# 定义 abstract 核心类型 - 用于包装各平台底层数类型. 对于 coreType 的 abstract 是不需要定义类型的
